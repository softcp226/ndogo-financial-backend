    ...
    html: `
        ...
        <div class="mail_template"
            ...
            <div style="margin-top: 30px;">
                ...
                <p style="font-size: 18px; color: #555;"> your withdrawal of ${userInfo.currency}${userInfo.amount} from your crescentpips trading account has been completed and funds has been credited to the wallet specified during withdrawal</p>
            </div>
            <div style="margin-top: 30px;">
